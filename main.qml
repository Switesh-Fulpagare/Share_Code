...
/**/
        ...
        SequentialAnimation{
            ...
            NumberAnimation{target: highbeam; property:  "y"; to: 70; duration: 10} //
            //NumberAnimation{target: highbeam; property:  "z"; to: 0; duration: 10}
            NumberAnimation{target: highbeam; property:  "scale"; to: 0.8; duration: 10}
            ...
            NumberAnimation{target: highbeam; property:  "x"; to: 235; duration: 10}
            NumberAnimation{target: highbeam; property:  "y"; to: 65; duration: 10}
            NumberAnimation{target: highbeam; property:  "scale"; to: 0.4; duration: 10}
            NumberAnimation{target: highBeam; property: "visible"; to: 0; duration: 100}
            ...
            NumberAnimation{ target:low_oil; property: "y"; to: 60; duration: 10} //230
            //NumberAnimation{target: low_oil; property:  "z"; to: 0; duration: 10}
            NumberAnimation{ target:low_oil; property: "scale"; to: 0.7; duration: 10}
            ...
            NumberAnimation{ target:battery_low; property: "y"; to: 60; duration: 10} //220
            //NumberAnimation{target: battery_low; property:  "z"; to: 0; duration: 10}
            NumberAnimation{ target:battery_low; property: "scale"; to: 0.7; duration: 10}
            ...
            NumberAnimation{ target:petrol_indicator; property: "y"; to: 40; duration: 10} //205
            //NumberAnimation{target: petrol_indicator; property:  "z"; to: 0; duration: 10}
            NumberAnimation{ target:petrol_indicator; property: "scale"; to: 0.5; duration: 10}
            ...
            NumberAnimation{ target:parking_light; property: "y"; to: 55; duration: 10} //223
            //NumberAnimation{ target:parking_light; property:  "z"; to: 0; duration: 10}
            NumberAnimation{ target:parking_light; property: "scale"; to: 0.55; duration: 10}
            ...
            NumberAnimation{ target:brakefailure; property: "y"; to: 70; duration: 10} //240
            //NumberAnimation{ target:brakefailure; property:  "z"; to: 0; duration: 10}
            NumberAnimation{ target:brakefailure; property: "scale"; to: 1; duration: 10}
